...
def get_data(number_phone): 
    ...
    with sync_playwright() as p: 
        ...
        try: 
            ...
            while while_counter < 3: 
                try:
                    ...
                    page.click('.rbico-add.rp')
                    page.locator('[name="first_name"]').wait_for(state='visible', timeout=2000)
                    page.fill('[name="first_name"]', number_phone)
                ...
                return(f'[green bold]Shad:[/green bold]\n[bright_yellow]{last_e}[/bright_yellow]')
        ...
        page.locator('.btn-icon.rbico-left.sidebar-close-button').nth(0).click()
        try: 
            page.click('.btn-icon.rbico-edit.rp')
            page.click('[rb-localize="user_modal_delete_contact"]')
                ...
                try: 
                    ...
                    while next_btn.count() > 0 and next_btn.is_visible(): 
                            try: 
                                ...
                                print(f'[red]A Problem In Loading Profile {img_counter} In Shad.[/red]')
                except:
                        console.print('[red]A Problem In Loading Profile(0Shad), Pls Try Again.[/red]')
                        img_counter = None
            except:
                console.print('[red]A Problem In Loading Profile(1Shad), Pls Try Again.[/red]')
                img_counter = None
        except:
            img_counter = 0             

        console.print('[green]Shad Finished Successfully![/green]')

        return(f'''
[green bold]Shad:[/green bold][bright_yellow]
[bold]Name:[/bold] {name}
