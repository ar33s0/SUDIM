...
def get_data(number_phone):
    ...
    with sync_playwright() as p: 
        ...
        try:
            ...
            try: 
                 page.locator('.Button.confirm-dialog-button:has-text("حذف مخاطب")').nth(0).click(timeout=100)
            except: 
                pass
        ...
        try: 
            ...
            try:
                ...
                pass
            page.locator('.MediaViewerContent').first.wait_for(state='attached', timeout=3000)
            try: 
                ...
                try:
                    ...
                    while next_btn.count() > 0 and next_btn.is_visible(): 
                        try: 
                            ...
                            print(f'[red]A Problem In Loading Profile {img_counter} In Splus.[/red]')
                except:
                    console.print('[red]A Problem In Loading Next Profile(0Splus), Pls Try Again.[/red]')
                    img_counter = None

            except:
                console.print('[red]A Problem In Loading Profile(1Splus), Pls Try Again.[/red]')
                img_counter = None
        except:
            img_counter = 0    
